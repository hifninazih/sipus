				...
				<form action="" method="post" enctype="multipart/form-data">
					<table class="form-table">
						<tr>
							...
							<td>					
								<input class="form-control mb-2" type="text" name="id_anggota" id="id_anggota" value="<?php echo $data['id_anggota']; ?>" readonly>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>								
								<input class="form-control mb-2" type="text" name="nama_lengkap" id="nama_lengkap" value="<?php echo $data['nama_lengkap']; ?>" required
						...
						<tr>
							...
							<td>								
								<textarea class="form-control mb-2" rows="3" cols="40" name="alamat" required
								oninvalid="this.setCustomValidity('Isi Alamat!')"
 								oninput="setCustomValidity('')"><?php echo $data['alamat']; ?></textarea>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								...
								?>
								<img class="mb-2" src="<?php echo './images/' . $data_foto; ?>" width="60">
								<input class="form-control-file mb-2" type="file" name="foto" id="foto">
						...
						<tr>
							...
							<td>								
								...
								<label for="status_true"><span class="badge badge-success">Aktif</span></label>

								<input type="radio" class="ml-1" name="status_aktif" value="T" id="status_false" <?php echo ($data['status_aktif'] == 'T') ? 'checked' : ''; ?> required>
								<label for="status_false"><span class="badge badge-secondary">Tidak Aktif</span></label>
							</td>
						</tr>
						<tr>
							<td>
